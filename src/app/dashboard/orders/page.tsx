...
import { getCurrentUser, getUserRole } from "@/app/actions/auth-actions"
import { getAllOrdersAdmin, getOrdersByProductCreator } from "@/app/actions/order-actions"
...
export default async function OrdersPage() {
    ...
    const orders = role === "admin" ? await getAllOrdersAdmin() : await getOrdersByProductCreator(user?.user_id)
    console.log(orders);
  ...
  return (
    <Card>
      ...
      <CardFooter className="flex justify-between">
        ...
        <Link href={`/dashboard/orders/product-view?order_id=${id}&product_id=${productId}`}>
